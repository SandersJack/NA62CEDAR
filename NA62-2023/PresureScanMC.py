...
#directory = '/eos/user/j/jsanders/cedar_roots/presure_scan_1/'

#directory = '/afs/cern.ch/work/c/cparkins/public/PRESS_4/'

#directory = '/eos/user/c/cparkins/public/PRESS_15mm/'

directory = '/eos/user/j/jsanders/N2_H/pressure/reco/'

c = 0

direcs = ['/eos/user/j/jsanders/pressure/N_2_0_NTemp/kaon/reco','/eos/user/j/jsanders/pressure/N_2_0_NTemp/proton/reco','/eos/user/j/jsanders/pressure/N_2_0_NTemp/pip/reco']
...
for t in range(len(direcs)):
    ...
    for filename in os.scandir(direcs[t]):
        if filename.is_file():
            ...
            #file_name = "/eos/user/j/jsanders/cedar_roots/presure_scan_1/na62om_1682642791-06-012840-0361.ds35.root"
...
for i in range(len(A_sec_8[0])):
    ...
    _sec_6.append((A_sec_6[0][i]+A_sec_6[1][i]*0.24/0.06+A_sec_8[2][i]*0.7/0.06)/triggers)
